...
return (
  ...
  <div className="final">
    ...
    <div className="final-description"> Вы выбрали направление 
      <span className="final-title__text--special">"{data.fromCity} - {data.fromCity}"</span>
    </div>
    <div className="final-description"> Ваш груз 
      <span className="final-title__text--special">{data.mass} тн, {data.volume} м3</span>
    </div>
    <div className="final-description"> Дата рейса 
      <span className="final-title__text--special">{data.date}</span>
    </div>
    <div className="final-description"> Стоимость поездки составит 
      <span className="final-title__text--special">{order.totalAmount} $.</span>
    </div>
