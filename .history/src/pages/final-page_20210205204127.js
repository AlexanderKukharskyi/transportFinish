...
return (
  ...
  <div className="final">
    ...
    <div className="final-description"> Вы выбрали направление: 
      <span className="final-description--special"> " {data.fromCityId} - {data.toCityId}  "</span>
    </div>
    ...
    <div className="final-description__with-image"> Выбранный транспорт --   
      <img className="final-image" src={imgPath} alt="vehicle"/>
    </div>
