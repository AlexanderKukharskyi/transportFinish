  ...
  <div className="results">
    ...
    <div className="results-menu">
      <ul className="results-list">
        {vehicles.vehiclesOption.map(item =><li key={item.id} className="results-link results-link--left"><a href="/success"><img className="results-img" src={item.path} alt="result" /></a></li>
)} 
